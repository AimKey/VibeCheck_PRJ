...
//            System.out.println(user + ":: accessing admin page");
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("SettingPageOnLoad: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("SettingPageOnLoad()");
        }
        StringBuffer sb = new StringBuffer("SettingPageOnLoad(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("SettingPageOnLoad::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("SettingPageOnLoad::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("SettingPageOnLoad::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("SettingPageOnLoad::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
