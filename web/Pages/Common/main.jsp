    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-3">
                <div class="infomusic">
                    <div class="music">
                        <img src="assets/images/demo.jpg" class="active" alt="demo" >
        ...
        <div class="row2">
            <div class="control-bar">
                ...
                <div class="song-play">
                    <img src="assets/images/demo.jpg" alt="demo" class="img-fluid">
                    <div class="song-info">
                        <p class="song-title">Bài gì cũng duoc nhung mà không phai bài đó</p>
                        <p class="artist-name">Artist Name</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="control">
                    ...
                    <span class="icon" id="prevBtn">
                        <ion-icon name="play-skip-back-outline" ></ion-icon>
                    </span>
                    <button class="icon-play" id="ctrlIcon">
                        <ion-icon name="play" ></ion-icon>
                    </button>
                    <span class="icon" id="nextBtn" >
