...
<div class="section" id="edit-playlist">
   ...
   <button type="button" class="button button-action" data-bs-toggle="modal" data-bs-target="#createPlaylistModal">
      Create New Playlist
   </button>
   ...
   <div class="playlist-information hide">
      ...
      <button
         class="playlist__toggle-change-name button-svg button-icon"
         data-bs-toggle="tooltip"
      ...
      <button
         class="playlist__confirm-change button-svg button-icon hide"
         data-bs-toggle="tooltip"
      ...
      <button
         class="playlist__cancel-change button-svg button-icon hide"
         data-bs-toggle="tooltip"
         title="Cancel change"
         type="button"
      >
      ...
      <button
         class="playlist__add-songs button-svg button-icon"
         type="button"
         data-bs-toggle="modal"
         data-bs-target="#add-song-modal"
         title="Button to add songs to the playlist"
         type="button"
      >
         <svg
            fill="#76abae"
      ...
      <!-- Play music button -->
      <button
         class="playlist__play-music button-svg button-icon"
         type="button"
         onclick="playMusic()"
         title="Play music from the playlist"
      >
         ...
         <div class="modal-content">
            ...
            <div class="modal-footer">
               ...
               <button
                  ...
                  onclick="document.getElementById('createPlaylistForm').submit();"
               >
                  Create
               </button>
            </div>
